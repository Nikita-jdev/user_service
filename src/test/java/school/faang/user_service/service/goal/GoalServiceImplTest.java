...
class GoalServiceImplTest {
    ...
    @Test
    public void whenFindByIdAndIdNotExistThenThrowException() {
    ...
    @Test
    public void whenFindByIdThenReturnGoalDto() {
        when(goalRepository.findById(GOAL_ID)).thenReturn(Optional.of(goal));
        when(goalMapper.toDto(goal)).thenReturn(goalDto);
        GoalDto actual = goalService.findById(GOAL_ID);
        assertThat(actual).isEqualTo(goalDto);
    }
